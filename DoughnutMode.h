 ...
 * This is the header .h file for the DoughnutMode class which is used to play Doughnut mode and print or output to a file the generations along with tell if the wolrd is stable or empty
*/
#include <iostream>
#include <fstream>
...
public:
  ...
  ~DoughnutMode(); //default desctructor
  ...
  void playDoughnutMode(char** world, unsigned short rows, unsigned short columns, unsigned short briefPause, string outputFile, unsigned int generationNumber); // plays the game of life in classic mode
private:
